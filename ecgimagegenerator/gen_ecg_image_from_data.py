...
def run_single_file(args):
        ...
        font = os.path.join(path,random.choice(os.listdir(path))) #changed the font loading part since the implememtation does not work, when clled from another file
